...
public class todaysActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            DBlistView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Intent i = new Intent(todaysActivity.this, ViewEventDetailedPopUp.class);
        ...
        {
            Intent intent = new Intent(todaysActivity.this, addMeetingPopUp.class);
            startActivity(intent);
        }

        public ArrayList<Event> selectAll() {
            ArrayList<Event> list = new ArrayList<>();
            Cursor date2 = database.getTodaysEvents();
