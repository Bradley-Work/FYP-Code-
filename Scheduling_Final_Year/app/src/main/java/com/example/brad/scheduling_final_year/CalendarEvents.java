...
public class CalendarEvents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DBlistView = (ListView) findViewById(R.id.calendarList);
        database = new DB(this);

        Intent calendarDates = getIntent();

        final Bundle stuff = calendarDates.getExtras();
        if (stuff != null) {
            calendarDate = stuff.getString("date");
        }
        ...
        DBlistView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(CalendarEvents.this, ViewEventDetailedPopUp.class);
    ...
    {
        Intent intent = new Intent(CalendarEvents.this, addMeetingPopUp.class);
        startActivity(intent);
    }

    public ArrayList<Event> selectAll() {
        ArrayList<Event> list = new ArrayList<>();
        Cursor date2 = database.getCalendarEvent(calendarDate);
