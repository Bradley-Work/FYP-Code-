...
public class HobbiesActivity extends AppCompatActivity {
        ...
        fillContent();
            DBlistView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Intent i = new Intent(HobbiesActivity.this, ViewEventDetailedPopUp.class);
    ...
    {
        Intent intent = new Intent(HobbiesActivity.this, addMeetingPopUp.class);
        startActivity(intent);
    }

    public ArrayList<Event> selectAll() {
        ArrayList<Event> list = new ArrayList<>();
        Cursor date2 = database.getHobbies();
