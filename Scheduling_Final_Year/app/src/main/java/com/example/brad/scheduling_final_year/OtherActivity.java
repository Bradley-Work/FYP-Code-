...
public class OtherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DBlistView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(OtherActivity.this, ViewEventDetailedPopUp.class);
    ...
    {
        Intent intent = new Intent(OtherActivity.this, addMeetingPopUp.class);
        startActivity(intent);
    }

    public ArrayList<Event> selectAll() {
        ArrayList<Event> list = new ArrayList<>();
        Cursor date2 = database.getOthers();
